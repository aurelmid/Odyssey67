...
## Parts List
 ...
 Part                                                                                                                                 |  Quantity
 :----------------------------------------------------------------------------------------------------------------------------------  |  :-------:
 [Odyssey 67 PCB](https://github.com/aurelmid/Odyssey67/blob/master/Gerbers.zip)                                              |  1
...
## Build Guide
 ...
 If you're new to this, make sure to study and follow the build guide available [here](https://github.com/aurelmid/Odyssey67/blob/master/BUILD_GUIDE.md).

## Firmware

 The keyboard is powered by [QMK Firmware](https://github.com/qmk/qmk_firmware). You can find the firmware for the Odyssey67 [here](https://github.com/aurelmid/Odyssey67/tree/master/Firmware/aurelmid/odyssey67).

 Add the `aurelmid` folder to your own fork of QMK to flash it to your keyboard.
...
## License
 ...
 Released under [MIT License](https://github.com/aurelmid/Odyssey67/blob/master/LICENSE).
